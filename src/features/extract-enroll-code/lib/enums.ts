...
export const MajorArray: { key: MajorMapKey; value: MajorMapValue }[] = Object.entries(MajorMap).map(([key, value]) => ({
  key: key as MajorMapKey,
  value,
}))

export const getMajorMapKey = (major: MajorMapValue): MajorMapKey | undefined => {
